...
exports.sendSignupDecisionEmail = sendSignupDecisionEmail;
exports.sendAccountRestrictionEmail = sendAccountRestrictionEmail;
exports.sendRiskFlagEmail = sendRiskFlagEmail;
...
async function createUserNotification(prisma, input) {
...
async function sendSignupDecisionEmail(params) {
...
async function sendAccountRestrictionEmail(params) {
...
async function sendRiskFlagEmail(params) {
    await sendEmail({
        to: params.to,
